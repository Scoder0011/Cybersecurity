...
--> Os command injection is also known as shell injection it allows the attacker to exicute the os commands on the server that is running an application and fully compromize the application and the the data . 
